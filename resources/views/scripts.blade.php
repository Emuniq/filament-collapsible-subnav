<style>
/* Critical CSS - loaded inline for zero FOUC */
...
.fi-subnav-collapsed .fi-page-sub-navigation-sidebar .fi-sidebar-item-button{justify-content:center;padding-left:.75rem;padding-right:.75rem}
